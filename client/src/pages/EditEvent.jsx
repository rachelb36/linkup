...
import { TextField, Box, Typography, IconButton, Tooltip, Alert, Button } from '@mui/material';
...
const EditEvent = ({ eventId, handleEditModalClose }) => {
  ...
  const [updateEvent] = useMutation(UPDATE_EVENT, {
    ...
    onCompleted: () => setShowSaveAlert(true),
  ...
  const handleDeleteConfirmation = () => {
    console.log("Delete confirmation triggered"); // Debug log to check if this function is called
    toast.info(
      <div>
  ...
  const confirmDelete = async () => {
    console.log("Confirm delete triggered"); // Debug log to check if delete is triggered
    try {
      await deleteEvent({
        variables: { id: eventId },
      });
      toast.dismiss(); // Close the confirmation toast after deletion
    } catch (err) {
